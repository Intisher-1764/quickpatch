...
/* === Helper: append a "Get a Quote" button after images (1 & 2) === */
function ensureQuoteButton(container) {
  if (!container) return;
  if (container.querySelector("#quoteAfterImageBtn")) return; // avoid duplicates
